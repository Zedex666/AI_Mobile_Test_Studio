...
Q_CONSTINIT const QMetaObject NavigationBar::staticMetaObject = { {
    ...
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN13NavigationBarE_t,
        ...
        QtPrivate::TypeAndForceComplete<NavItem, std::false_type>
    >,
    nullptr
} };
...
void NavigationBar::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->itemClicked((*reinterpret_cast< std::add_pointer_t<NavItem>>(_a[1]))); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        {
            using _q_method_type = void (NavigationBar::*)(NavItem );
            if (_q_method_type _q_method = &NavigationBar::itemClicked; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void NavigationBar::itemClicked(NavItem _t1)
{
