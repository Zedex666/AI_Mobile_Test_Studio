...
static constexpr auto qt_meta_stringdata_ZN11BottomPanelE = QtMocHelpers::stringData(
    "BottomPanel",
    "onLogEmitted",
    "",
    "text"
...
Q_CONSTINIT static const uint qt_meta_data_ZN11BottomPanelE[] = {
...
Q_CONSTINIT const QMetaObject BottomPanel::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN11BottomPanelE.offsetsAndSizes,
    qt_meta_data_ZN11BottomPanelE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN11BottomPanelE_t,
        // Q_OBJECT / Q_GADGET
...
void BottomPanel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->onLogEmitted((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1]))); break;
        default: ;
        }
    }
}
...
void *BottomPanel::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN11BottomPanelE.stringdata0))
